...
{
    public class KafkaTemplateProducer : IDisposable
    {
        private readonly IConfiguration _configuration;
        private readonly ILogger<KafkaTemplateProducer> _logger;
        ...
        public KafkaTemplateProducer(IConfiguration configuration, ILogger<KafkaTemplateProducer> logger)
        {
